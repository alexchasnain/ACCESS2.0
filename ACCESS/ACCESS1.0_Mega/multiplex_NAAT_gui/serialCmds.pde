...
void serialCmd(String cmd) {
    ...
    if (cmd.equals("home")) {
      ...
      displayMode = 4;  // magnet options
         ...
         */
        println( "Starting run with filename: " + output_file);
     ...
     *******************/
        ...
        if (eselogConnected) {
            if (detect_flag && !serialString.equals("scan")) {
                detect_flag = false;
                detect_val = serialString.substring(0, serialString.length()-1);
